...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        if (authentication != null && authentication.isAuthenticated()) {
            if (hasAuthority("ROLE_ADMIN")) {
                configurarVistaAdmin(nav);
            } else if (hasAuthority("ROLE_PROFESOR")) {
                configurarVistaProfesor(nav);
            } else if (hasAuthority("ROLE_ESTUDIANTE")) {
                configurarVistaEstudiante(nav);
            }
        }
    ...
    private void configurarVistaAdmin(SideNav nav) {
        ...
        nav.addItem(new SideNavItem("Historial por Estudiante", "historial-estudiante", LineAwesomeIcon.USER.create()));
    }

    private void configurarVistaProfesor(SideNav nav) {
    ...
    private void configurarVistaEstudiante(SideNav nav) {
